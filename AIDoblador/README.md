...
<h1 align="center">🎥 AIDoblador 🈷️</h1>

## 🎬 Video Translation with Synchronized Audio 🌐

AIDoblador is a powerful and user-friendly web application that allows you to easily translate videos into different languages. This repository hosts the code for the AIDoblador web UI, which is built with the Gradio library to provide a seamless and interactive user experience.


| Description | Link |
| ----------- | ---- |
| 📙 Colab Notebook | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/R3gm/AIDoblador/blob/main/AIDoblador_Colab.ipynb) |
| 🎉 Repository | [![GitHub Repository](https://img.shields.io/badge/GitHub-Repository-black?style=flat-square&logo=github)](https://github.com/R3gm/AIDoblador/) |
...
## AIDoblador's web UI, which features a browser interface built on the Gradio library.
![image](https://github.com/R3gm/AIDoblador/assets/114810545/0d71fbf4-e9f0-4f8f-944e-8f3f1ea6a019)
...
https://github.com/R3gm/AIDoblador/assets/114810545/db9e78c0-b228-4e81-9704-e62d5cc407a3



### Translated audio

https://github.com/R3gm/AIDoblador/assets/114810545/6a8ddc65-a46f-4653-9726-6df2615f0ef9


## Colab Runtime

To run AIDoblador using Colab Runtime: [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/R3gm/AIDoblador/blob/main/AIDoblador_Colab.ipynb)

## Install Locally (Installation tested in Linux)

### Before You Start

Before you start installing and using AIDoblador, there are a few things you need to do:
...
Once you have completed these steps, you will be ready to install AIDoblador.

### Getting Started

To install AIDoblador, follow these steps:

1. Create a suitable anaconda environment for AIDoblador and activate it:
...
```
git clone https://github.com/r3gm/AIDoblador.git
cd AIDoblador
```
...
To run AIDoblador locally, make sure the `sonitr` conda environment is active:
...
Then navigate to the `AIDoblador` folder and run either the `app_rvc.py`

```
python app_rvc.py
```
When the `local URL` `http://127.0.0.1:7860` is displayed in the terminal, simply open this URL in your web browser to access the AIDoblador interface.

### Stop and close AIDoblador.
...
If you need to start over from scratch, you can delete the `AIDoblador` folder and remove the `sonitr` conda environment with the following set of commands:
