...
# 2. Patch torchaudio for pyannote.audio compatibility (Torchaudio 2.10+)
import torchaudio
...
# 3. Patch torch.load for PyTorch 2.6+ compatibility (Fix weights_only=True)
import torch
...
# 4. Patch whisperx to expose DiarizationPipeline
import whisperx
try:
...
title = "<center><strong><font size='7'>📽️ AIDoblador 🈷️</font></strong></center>"
