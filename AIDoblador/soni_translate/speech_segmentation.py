...
diarization_models = {
    ...
    "pyannote_2.1": "pyannote/speaker-diarization-3.1", # Defaulting to 3.1 to avoid speechbrain 404 (custom.py) error
    "disable": "",
}
        ...
        try:
            ...
            if "'NoneType' object has no attribute 'to'" in error_str:
                if model_name == diarization_models["pyannote_2.1"]:
                    raise ValueError(
                        "Accept the license agreement for using Pyannote 3.1."
