...
language_data = {
    "english": {
        "description": """
        ### 🎥 **Translate videos easily with AIDoblador!** 📽️

        Upload a video, subtitle, audio file or provide a URL video link. 📽️ **Gets the updated notebook from the official repository.: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador supports different TTS (Text-to-Speech) engines, which are:**
    ...
    "spanish": {
        "description": """
        ### 🎥 **¡Traduce videos fácilmente con AIDoblador!** 📽️

        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador admite diferentes motores de TTS (Texto a Voz), los cuales son:**
    ...
    "french": {
        "description": """
        ### 🎥 **Traduisez facilement les vidéos avec AIDoblador !** 📽️

        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador prend en charge différents moteurs TTS (Text-to-Speech), à savoir :**
    ...
    "german": {
        "description": """
        ### 🎥 **Übersetzen Sie Videos einfach mit AIDoblador!** 📽️

        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador unterstützt verschiedene TTS (Text-to-Speech)-Engines, darunter:**
    ...
    "italian": {
        "description": """
        ### 🎥 **Traduci i video facilmente con AIDoblador!** 📽️

        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador supporta diversi motori TTS (Text-to-Speech), tra cui:**
    ...
    "japanese": {
        "description": """
        ### 🎥 **AIDobladorで簡単に動画を翻訳しましょう！** 📽️

        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDobladorはさまざまなTTS（テキスト読み上げ）エンジンをサポートしています。これらは次のとおりです:**
    ...
    "chinese_zh_cn": {
        "description": """
          ### 🎥 **使用AIDoblador轻松翻译视频！** 📽️

          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        "tutorial": """
          ...
          # 🧩 **AIDoblador支持不同的TTS（文本到语音）引擎，包括:**
    ...
    "ukrainian": {
        "description": """
        ### 🎥 **Перекладайте відео легко з AIDoblador!** 📽️

        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador підтримує різні двигуни TTS (текст-у-мову), які є:**
    ...
    "arabic": {
        "description": """
          ### 🎥 **ترجمة مقاطع الفيديو بسهولة مع AIDoblador!** 📽️

          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        "tutorial": """
          ...
          # 🧩 **يدعم AIDoblador محركات TTS (نص إلى كلام) مختلفة، وهي:**
    ...
    "russian": {
        "description": """
        ### 🎥 **Перевод видео легко с AIDoblador!** 📽️

        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador поддерживает различные движки TTS (текст в речь), которые включают:**
    ...
    "turkish": {
        "description": """
        ### 🎥 **AIDoblador ile videoları kolayca çevirin!** 📽️

        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador, farklı TTS (Metin-okuma-sesi) motorlarını destekler, bunlar:**
    ...
    "indonesian": {
        "description": """
        ### 🎥 **Terjemahkan video dengan mudah menggunakan AIDoblador!** 📽️

        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador mendukung berbagai mesin TTS (Teks-ke-Suara), yaitu:**
    ...
    "portuguese": {
        "description": """
        ### 🎥 **Traduza vídeos facilmente com o AIDoblador!** 📽️

        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador suporta diferentes motores TTS (Texto para Fala), que são:**
    ...
    "hindi": {
        "description": """
          ### 🎥 **AIDoblador के साथ वीडियो को आसानी से अनुवादित करें!** 📽️

          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        "tutorial": """
          ...
          # 🧩 **AIDoblador विभिन्न TTS (टेक्स्ट-टू-स्पीच) इंजनों का समर्थन करता है, जो हैं:**
    ...
    "vietnamese": {
        "description": """
        ### 🎥 **Dịch video dễ dàng với AIDoblador!** 📽️

        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador hỗ trợ các công cụ TTS (Text-to-Speech) khác nhau, bao gồm:**
    ...
    "polish": {
        "description": """
        ### 🎥 **Łatwe tłumaczenie filmów dzięki AIDoblador!** 📽️

        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador obsługuje różne silniki TTS (tekst do mowy), które to:**
    ...
    "swedish": {
        "description": """
        ### 🎥 **Översätt videor enkelt med AIDoblador!** 📽️

        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador stöder olika TTS (Text-to-Speech) motorer, vilka är:**
    ...
    "korean": {
        "description": """
        ### 🎥 **AIDoblador를 사용하여 비디오를 쉽게 번역하세요!** 📽️

        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador는 다양한 TTS (텍스트 음성 변환) 엔진을 지원합니다. 이는 다음과 같습니다:**
    ...
    "marathi": {
        "description": """
        ### 🎥 **आसानीसोबत AIDoblador द्वारे व्हिडिओ अनुवाद करा!** 📽️

        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador विविध TTS (पाठ-टू-स्पीच) इंजिनसाठी समर्थन करते, ज्या म्हणजे:**
    ...
    "azerbaijani": {
        "description": """
        ### 🎥 **AIDoblador ilə videoları asanlıqla tərcümə edin!** 📽️

        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **AIDoblador-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador, fərqli TTS (Mətnə Səsləndirmə) mühərriklərini dəstəkləyir ki, onlar:**
    ...
    "persian": {
        "description": """
        ### 🎥 **با AIDoblador به راحتی ویدئوها را ترجمه کنید!** 📽️

        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador از موتورهای مختلف TTS (متن به گفتار) پشتیبانی می‌کند، که شامل:**
    ...
    "afrikaans": {
        "description": """
        ### 🎥 **Vertaal video's maklik met AIDoblador!** 📽️

        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [AIDoblador](https://github.com/genesislloretramos/AIDoblador)!**
        ...
        # 🧩 **AIDoblador ondersteun verskillende TTS (Teks-na-Spraak) enjins, wat is:**
...
language_data["catalan"] = {
    ...
    1. 📤 Puja un fitxer de **vídeo**, **àudio** o proporciona un enllaç de 🌐 **YouTube**.

    2. 🌍 Tria l'idioma al qual vols **traduir el vídeo**.

    3. 🗣️ Especifica el **nombre de persones que parlen** al vídeo i **assigna a cadascuna una veu de text a veu** adequada per a l'idioma de traducció.

    4. 🚀 Prem el botó '**Tradueix**' per obtenir els resultats.

    ---

    # 🧩 **AIDoblador admet diferents motors de TTS (Text a Veu), que són:**
    - EDGE-TTS → format `en-AU-WilliamNeural-Male` → Ràpids i precisos.
    - FACEBOOK MMS → format `en-facebook-mms VITS` → Veu més natural, de moment només utilitza CPU.
    - PIPER TTS → format `en_US-lessac-high VITS-onnx` → Igual que l'anterior, però està optimitzat tant per a CPU com per a GPU.
    - BARK → format `en_speaker_0-Male BARK` → De bona qualitat però lent i propens a al·lucinacions.
    - OpenAI TTS → format `>alloy OpenAI-TTS` → Multilingüe però necessita una clau API d'OpenAI.
    - Coqui XTTS → format `_XTTS_/AUTOMATIC.wav` → Només disponible per a xinès (simplificat), anglès, francès, alemany, italià, portuguès, polonès, turc, rus, holandès, txec, àrab, espanyol, hongarès, coreà i japonès.

    ---

    # 🎤 Com utilitzar les veus R.V.C. i R.V.C.2 (Opcional) 🎶

    L'objectiu és aplicar un R.V.C. al TTS (Text a Veu) generat 🎙️

    1. A la pestanya `Veu Personalitzada R.V.C.`, descarrega els models que necessites 📥 Pots utilitzar enllaços de Hugging Face i Google Drive en formats com zip, pth o index. També pots descarregar repositoris complets d'espai HF, però aquesta opció no és gaire estable 😕

    2. Ara, ves a `Substituir veu: TTS a R.V.C.` i marca la casella `activar` ✅ Després d'això, pots triar els models que vols aplicar a cada parlant de TTS 👩‍🦰👨‍🦱👩‍🦳👨‍🦲

    3. Ajusta el mètode F0 que s'aplicarà a tots els R.V.C. 🎛️

    4. Prem `APLICAR CONFIGURACIÓ` per aplicar els canvis que hagis fet 🔄

    5. Torna a la pestanya de traducció de vídeo i fes clic a 'Tradueix' ▶️ Ara, la traducció es realitzarà aplicant el R.V.C. 🗣️

    Consell: Pots utilitzar `Provar R.V.C.` per experimentar i trobar el millor TTS o configuracions per aplicar al R.V.C. 🧪🔍

    ---

    """,
    "tab_translate": "Traducció de vídeo",
    "video_source": "Tria la Font de Vídeo",
    "link_label": "Enllaç multimèdia.",
    "link_info": "Exemple: www.youtube.com/watch?v=g_9rPvbENUw",
    "link_ph": "L'URL va aquí...",
    "dir_label": "Camí del vídeo.",
    "dir_info": "Exemple: /usr/home/my_video.mp4",
    "dir_ph": "El camí va aquí...",
    "sl_label": "Idioma d'origen",
    "sl_info": "Aquest és l'idioma original del vídeo",
    "tat_label": "Tradueix l'àudio a",
    "tat_info": "Selecciona l'idioma de destí i assegura't també de triar el TTS corresponent per a aquest idioma.",
    "num_speakers": "Selecciona quantes persones parlen al vídeo.",
    "min_sk": "Mín. parlants",
    "max_sk": "Màx. parlants",
    "tts_select": "Selecciona la veu que vols per a cada parlant.",
    "sk1": "TTS Parlant 1",
    "sk2": "TTS Parlant 2",
    "sk3": "TTS Parlant 3",
    "sk4": "TTS Parlant 4",
    ...
    "sk11": "TTS Parlant 11",
    "sk12": "TTS Parlant 12",
    "vc_title": "Imitació de veu en diferents idiomes",
    "vc_subtitle": """
    ### Replica la veu d'una persona en diversos idiomes.
    Tot i que és efectiu amb la majoria de les veus quan s'utilitza adequadament, pot no assolir la perfecció en tots els casos.
    La imitació de veu només replica el to del parlant de referència, excloent l'accent i l'emoció, qui són governats pel model TTS del parlant base i no replicats pel convertidor.
    Això prendrà mostres d'àudio de l'àudio principal per a cada parlant i les processarà.
    """,
    "vc_active_label": "Imitació de veu activa",
    "vc_active_info": "Imitació de veu activa: Replica el to del parlant original",
    "vc_method_label": "Mètode",
    "vc_method_info": "Selecciona un mètode per al procés d'imitació de veu",
    "vc_segments_label": "Màx. mostres",
    "vc_segments_info": "Màx. mostres: És el nombre de mostres d'àudio que es generaran per al procés, més és millor però pot afegir soroll",
    "vc_dereverb_label": "Desreverberació",
    "vc_dereverb_info": "Desreverberació: Aplica la desreverberació vocal a les mostres d'àudio.",
    "vc_remove_label": "Eliminar mostres anteriors",
    "vc_remove_info": "Eliminar mostres anteriors: Elimina les mostres generades anteriorment, per la qual cosa cal crear-ne de noves.",
    "xtts_title": "Crear un TTS basat en un àudio",
    "xtts_subtitle": "Puja un fitxer d'àudio de màxim 10 segons amb una veu. Utilitzant XTTS, es crearà un nou TTS amb una veu similar al fitxer d'àudio proporcionat.",
    "xtts_file_label": "Puja un àudio curt amb la veu",
    "xtts_name_label": "Nom per al TTS",
    "xtts_name_info": "Utilitza un nom senzill",
    "xtts_dereverb_label": "Desreverberació d'àudio",
    "xtts_dereverb_info": "Desreverberació d'àudio: Aplica la desreverberació vocal a l'àudio",
    "xtts_button": "Processa l'àudio i inclou-lo al selector de TTS",
    "xtts_footer": "Generar veu XTTS automàticament: Pots utilitzar `_XTTS_/AUTOMATIC.wav` al selector de TTS per generar automàticament segments per a cada parlant en generar la traducció.",
    "extra_setting": "Configuració Avançada",
    "acc_max_label": "Acceleració màx. d'àudio",
    "acc_max_info": "Acceleració màxima per als segments d'àudio traduïts per evitar solapaments. Un valor d'1.0 representa cap acceleració",
    "acc_rate_label": "Regulació de la Taxa d'Acceleració",
    "acc_rate_info": "Regulació de la Taxa d'Acceleració: Ajusta l'acceleració per adaptar-se a segments que requereixen menys velocitat, mantenint la continuïtat i considerant el moment d'inici següent.",
    "or_label": "Reducció de solapament",
    "or_info": "Reducció de solapament: Assegura que els segments no se solapin ajustant els temps d'inici en funció dels temps de finalització anteriors; podria interrompre la sincronització.",
    "aud_mix_label": "Mètode de Mescla d'Àudio",
    "aud_mix_info": "Mescla fitxers d'àudio original i traduït per crear una sortida personalitzada i equilibrada amb dos modes de mescla disponibles.",
    "vol_ori": "Volum àudio original",
    "vol_tra": "Volum àudio traduït",
    "voiceless_tk_label": "Pista sense veu",
    "voiceless_tk_info": "Pista sense veu: Elimina les veus de l'àudio original abans de combinar-lo amb l'àudio traduït.",
    "sub_type": "Tipus de subtítol",
    "soft_subs_label": "Subtítols Suaus",
    "soft_subs_info": "Subtítols Suaus: Subtítols opcionals que els espectadors poden activar o desactivar mentre veuen el vídeo.",
    "burn_subs_label": "Gravar Subtítols",
    "burn_subs_info": "Gravar Subtítols: Incrusta els subtítols al vídeo, convertint-los en una part permanent del contingut visual.",
    "whisper_title": "Configuració transcripció.",
    "lnum_label": "Literalitzar Números",
    "lnum_info": "Literalitzar Números: Substitueix representacions numèriques pels seus equivalents escrits a la transcripció.",
    "scle_label": "Neteja de So",
    "scle_info": "Neteja de So: Millora de vocals, elimina soroll de fons abans de la transcripció per a una precisió màxima en la marca de temps. Aquesta operació pot trigar temps, especialment amb fitxers d'àudio extensos.",
    "sd_limit_label": "Límit de Durada del Segment",
    "sd_limit_info": "Especifica la durada màxima (en segons) per a cada segment. L'àudio es processarà utilitzant VAD, limitant la durada per a cada fragment de segment.",
    "asr_model_info": "Converteix el llenguatge parlat a text utilitzant el model 'Whisper' per defecte. Utilitza un model personalitzat, per exemple, introduint el nom del repositori 'BELLE-2/Belle-whisper-large-v3-zh' al menú desplegable per utilitzar un model xinès preajustat. Troba models preajustats a Hugging Face.",
    "ctype_label": "Tipus de Càlcul",
    "ctype_info": "Triar tipus més petits com int8 o float16 pot millorar el rendiment reduint l'ús de memòria i augmentant el rendiment computacional, però pot sacrificar precisió en comparació amb tipus de dades més grans com float32.",
    "batchz_label": "Mida del Lot",
    "batchz_info": "Reduir la mida del lot estalvia memòria si la teva GPU té menys VRAM i ajuda a gestionar problemes de falta de memòria.",
    "tsscale_label": "Escala de Segmentació de Text",
    "tsscale_info": "Divideix el text en segmentos per frases, paraules o caràcters. La segmentació per paraules i caràcters ofereix una granularitat més fina, útil per a subtítols; desactivar la traducció conserva l'estructura original.",
    "srt_file_label": "Puja un fitxer de subtítols SRT (S'utilitzarà en lloc de la transcripció de Whisper)",
    "divide_text_label": "Redividir segments de text per:",
    "divide_text_info": "(Experimental) Introdueix un separador per dividir els segments de text existents en l'idioma d'origen. L'eina identificarà les ocurrències i crearà nous segments en conseqüència. Especifica múltiples separadors utilitzant |, per ex.: !|?|...|。",
    "diarization_label": "Model de diarització",
    "tr_process_label": "Procés de traducció",
    "out_type_label": "Tipus de sortida",
    "out_name_label": "Nom del fitxer",
    "out_name_info": "El nom del fitxer de sortida",
    "task_sound_label": "So d'estat de la tasca",
    "task_sound_info": "So d'estat de la tasca: Reprodueix una alerta de so que indica la finalització de la tasca o errors durant l'execució.",
    "cache_label": "Recuperar Progrés",
    "cache_info": "Recuperar Progrés: Continuar procés des de l'últim punt de control.",
    "preview_info": "Previsualització talla el vídeo a només 10 segons per a proves. Si us plau, desactiva'l per obtenir la durada completa del vídeo.",
    "edit_sub_label": "Editar subtítols generats",
    "edit_sub_info": "Editar subtítols generats: Et permet executar la traducció en 2 passos. Primer amb el botó 'OBTENIR SUBTÍTOLS I EDITAR', obtens els subtítols per editar-los, i després amb el botó 'TRADUIR', pots generar el vídeo",
    "button_subs": "OBTENIR SUBTÍTOLS I EDITAR",
    "editor_sub_label": "Subtítols generats",
    "editor_sub_info": "Sent-te lliure d'editar el text als subtítols generats aquí. Pots fer canvis a les opcions de la interfície abans de fer clic al botó 'TRADUIR', excepte 'Idioma d'origen', 'Tradueix l'àudio a' i 'Màx. parlants', per evitar errors. Un cop acabis, fes clic al botó 'TRADUIR'.",
    "editor_sub_ph": "Prem primer 'OBTENIR SUBTÍTOLS I EDITAR' per obtenir els subtítols",
    "button_translate": "TRADUIR",
    "output_result_label": "DESCARREGAR VÍDEO TRADUÏT",
    "sub_ori": "Subtítols",
    "sub_tra": "Subtítols traduïts",
    "ht_token_info": "Un pas important és acceptar l'acord de llicència per utilitzar Pyannote. Has de tenir un compte a Hugging Face i acceptar la llicència per utilitzar els models: https://huggingface.co/pyannote/speaker-diarization i https://huggingface.co/pyannote/segmentation. Obté el teu TOKEN CLAU aquí: https://hf.co/settings/tokens",
    "ht_token_ph": "Token va aquí...",
    "tab_docs": "Traducció de document",
    "docs_input_label": "Tria la Font del Document",
    "docs_input_info": "Pot ser PDF, DOCX, TXT o text",
    "docs_source_info": "Aquest és l'idioma original del text",
    "chunk_size_label": "Nombre màxim de caràcters que el TTS processarà per segment",
    "chunk_size_info": "Un valor de 0 assigna un valor dinàmic i més compatible per al TTS.",
    "docs_button": "Inicia el Pont de Conversió d'Idioma",
    "cv_url_info": "Descarrega automàticament els models R.V.C. des de l'URL. Pots utilitzar enllaços de HuggingFace o Drive, i pots incloure diversos enllaços, cadascun separat per una coma. Exemple: https://huggingface.co/sail-rvc/yoimiya-jp/blob/main/model.pth, https://huggingface.co/sail-rvc/yoimiya-jp/blob/main/model.index",
    "replace_title": "Substituir veu: TTS a R.V.C.",
    "sec1_title": "### 1. Per habilitar el seu ús, marca-ho com a habilitat.",
    "enable_replace": "Marca això per habilitar l'ús dels models.",
    "sec2_title": "### 2. Selecciona una veu que s'aplicarà a cada TTS de cada parlant corresponent i aplica les configuracions.",
    "sec2_subtitle": "Depenent de quants <TTS Parlant> utilitzis, cadascun necessita el seu model respectiu. A més, n'hi ha un d'auxiliar si per alguna raó el parlant no és detectat correctament.",
    "cv_tts1": "Tria la veu per aplicar al Parlant 1.",
    "cv_tts2": "Tria la veu per aplicar al Parlant 2.",
    "cv_tts3": "Tria la veu per aplicar al Parlant 3.",
    "cv_tts4": "Tria la veu per aplicar al Parlant 4.",
    "cv_tts5": "Tria la veu per aplicar al Parlant 5.",
    "cv_tts6": "Tria la veu per aplicar al Parlant 6.",
    "cv_tts7": "Tria la veu per aplicar al Parlant 7.",
    "cv_tts8": "Tria la veu per aplicar al Parlant 8.",
    "cv_tts9": "Tria la veu per aplicar al Parlant 9.",
    "cv_tts10": "Tria la veu per aplicar al Parlant 10.",
    "cv_tts11": "Tria la veu per aplicar al Parlant 11.",
    "cv_tts12": "Tria la veu per aplicar al Parlant 12.",
    "cv_aux": "- Veu per aplicar en cas que un Parlant no sigui detectat correctament.",
    "cv_button_apply": "APLICAR CONFIGURACIÓ",
    "tab_help": "Ajuda",
}
