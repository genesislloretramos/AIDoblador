...
language_data = {
    "english": {
        ...
        Upload a video, subtitle, audio file or provide a URL video link. 📽️ **Gets the updated notebook from the official repository.: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "spanish": {
        ...
        Sube un video, audio o proporciona un enlace de YouTube. 📽️ **Obtén el cuaderno actualizado desde el repositorio oficial: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "french": {
        ...
        Téléchargez une vidéo, un fichier audio ou fournissez un lien YouTube. 📽️ **Obtenez le notebook mis à jour à partir du référentiel officiel : [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "german": {
        ...
        Laden Sie ein Video, eine Audiodatei hoch oder geben Sie einen YouTube-Link an. 📽️ **Holen Sie sich das aktualisierte Notizbuch aus dem offiziellen Repository: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "italian": {
        ...
        Carica un video, un file audio o fornisci un link YouTube. 📽️ **Ottieni il notebook aggiornato dal repository ufficiale: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "japanese": {
        ...
        動画、音声ファイルをアップロードするか、YouTubeのリンクを提供してください。📽️ **公式リポジトリから最新のノートブックを入手する: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "chinese_zh_cn": {
        "description": """
          ...
          上传视频、音频文件或提供YouTube链接。 📽️ **从官方存储库获取更新的笔记本：[AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "ukrainian": {
        ...
        Завантажте відео, аудіофайл або надайте посилання на YouTube. 📽️ **Отримайте оновлений ноутбук з офіційного репозиторію: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "arabic": {
        "description": """
          ...
          قم بتحميل ملف فيديو أو صوتي أو قدم رابطًا لفيديو YouTube. 📽️ **احصل على الدفتر المحدث من المستودع الرسمي: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "russian": {
        ...
        Загрузите видео, аудиофайл или предоставьте ссылку на YouTube. 📽️ **Получите обновленный блокнот из официального репозитория.: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "turkish": {
        ...
        Bir video yükleyin, ses dosyası ekleyin veya bir YouTube bağlantısı sağlayın. 📽️ **Güncellenmiş notebook'ı resmi depodan alın: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "indonesian": {
        ...
        Unggah video, file audio, atau berikan tautan YouTube. 📽️ **Dapatkan buku catatan yang diperbarui dari repositori resmi: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "portuguese": {
        ...
        Carregue um vídeo, arquivo de áudio ou forneça um link do YouTube. 📽️ **Obtenha o caderno atualizado do repositório oficial: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "hindi": {
        "description": """
          ...
          एक वीडियो, ऑडियो फ़ाइल अपलोड करें या एक YouTube लिंक प्रदान करें। 📽️ **आधिकारिक भंडार से अपडेटेड नोटबुक प्राप्त करें: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "vietnamese": {
        ...
        Tải lên một video, tập tin âm thanh hoặc cung cấp một liên kết YouTube. 📽️ **Nhận sổ tay cập nhật từ kho chính thức: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "polish": {
        ...
        Prześlij film, plik dźwiękowy lub podaj link do YouTube. 📽️ **Pobierz aktualny notatnik ze strony oficjalnego repozytorium: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "swedish": {
        ...
        Ladda upp en video, ljudfil eller ange en YouTube-länk. 📽️ **Få den uppdaterade anteckningsboken från det officiella arkivet: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "korean": {
        ...
        비디오, 오디오 파일을 업로드하거나 YouTube 링크를 제공하세요. 📽️ **공식 저장소에서 최신 노트북을 받으세요.: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "marathi": {
        ...
        एक व्हिडिओ, ऑडिओ फाईल अपलोड करा किंवा एक YouTube लिंक प्रदान करा. 📽️ **अद्यतनित नोटबुक घ्या आधिकृत भंडारात।: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "azerbaijani": {
        ...
        Video, səs faylı yükləyin və ya YouTube bağlantısı təqdim edin. 📽️ **AIDoblador-in rəsmi repositoriyasından yenilənmiş qeydləri alın: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "persian": {
        ...
        یک ویدئو، فایل زیرنویس، فایل صوتی را آپلود کنید یا یک لینک ویدئوی URL ارائه دهید. 📽️ **دفترچه یادداشت به‌روز شده را از مخزن رسمی دریافت کنید: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
    ...
    "afrikaans": {
        ...
        Laai 'n video, onderskrif, klanklêer op of verskaf 'n URL-videolink. 📽️ **Kry die opgedateerde notaboek van die amptelike repository: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
...
language_data["catalan"] = {
    ...
    Puja un vídeo, àudio o proporciona un enllaç de YouTube. 📽️ **Obté el notebook actualitzat del repositori oficial: [AIDoblador](https://github.com/R3gm/AIDoblador)!**
